...
<html <?php language_attributes(); ?>>
    	...
    	if($_REQUEST["loginpopup"])
		{
			...
			<script type="text/javascript">
				...
				jQuery(document).ready(function(){
					...
					jQuery("#openlogin").trigger('click');
            ...
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-8 col-xs-12">
                    <ul class="nav nav-tabs contact-nav">
                        <li><a href=""><strong>Phone:</strong> 800.659.9680</a></li>
        ...
        <div class="modal-dialog pop-up">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <h5 class="noMargin dM"><?php _e('New User', 'twentyten') ?><a href="#signup-modal" class="" id="go-signup-btn" data-toggle="modal" role="button"><?php _e('Click here', 'twentyten') ?></a></h5>
    ...
    <div class="is-section is-feature">
	  ...
	  if($post->ID == $pid) { # Code to show message on sign up page
		?>
 ...
 <div class="page-sub-page">
		...
		jQuery(document).ready( function() {
			...
			jQuery(".video-list").click(function(){

				var youtube_id = this.id;

				var youtube_title = jQuery("#"+youtube_id).attr("data-youtube-title");
				var current_id = jQuery("#theMainPlayer").attr("data-youtube");
				var current_title = jQuery("#theMainPlayer").attr("data-youtube-title");
				var current_image = jQuery("#theMainPlayer").attr("data-youtube-image");
				jQuery("#theMainPlayer").attr("src", "//player.vimeo.com/video/"+youtube_id);
				jQuery("#theMainPlayer").attr("data-youtube", youtube_id);
				jQuery("#theMainPlayer").attr("data-youtube-title", youtube_title);
				jQuery("#"+youtube_id).attr("data-youtube-title", current_title);
				jQuery("#"+youtube_id).attr("id", current_id);				
				jQuery("#"+youtube_id).attr("data-youtube-image", current_image);
				jQuery("#"+ current_id +" .content-holder").html( current_title );
				jQuery("#"+ current_id +" .img-holder").html( '<img id="image_'+ current_id +'" src="http://i.vimeocdn.com/video/'+ current_image +'_200x150.jpg" />' );			
