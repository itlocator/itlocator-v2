jQuery(document).ready(function() {
     ...
     * edit profile
     */
     jQuery( ".delete_comp_file" ).click(function() {
     ...
     * login
     */
     jQuery("#mylogin-form").submit(function( event ) {
   // jQuery("#mylogin-form").live('submit', function () {
     ...
     jQuery( "#go-forgot-pw" ).click(function() {
     ...
     * signup
     */ 
      jQuery("#mysignup-form").submit(function( event ) {   
    //jQuery("#mysignup-form").live('submit', function () {
...
jQuery('#credit_card_update').click(function(){
   window.location.href='http://www.itlocator.com/credit-card/';
return false;
});	
});