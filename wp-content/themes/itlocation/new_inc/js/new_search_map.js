function homepage_go_advanced_search(){
	...
	else if(  jQuery("#countries").val() == 'byaddress' ){
		advanced_search_url = "http://www.itlocator.com/advanced-search/?searchbyaddress=true&lo=&co=&ke=" + jQuery("#keywords").val() +"&byaddress=" + jQuery("#lo").val() + "&" + service_param + "&advanced-search-btn=Search";
		}
else {
