...
if ($modal_id) {
    ...
    <script>
            ...
            new AjaxUpload(btnUpload, {
                ...
                onComplete: function(file, response){
                    ...
                    if(response.error) {
                        ...
                        // jQuery('#<?php echo $modal_id ?>_modal .file-photo').attr('src',file);
        ...
        /*    jQuery('#<?php echo $modal_id ?>_modal').on('hide', function () {
                if(jQuery('#<?php echo $modal_id ?>_modal .file-name').html()) {alert("hello");
                alert(jQuery('#<?php echo $modal_id ?>_modal #<?php echo $modal_id ?>_comp_file_title').val());
                    jQuery.ajax({
                        type : "post",
                        dataType : "json",
                        url : admin_ajax.url,
    ...
    if (count($file_info_list)) {
        foreach ($file_info_list as $file_info) {
            ...
            <tr>
                <td>
                    <div>
                        <span class="pull-left title"><?php _e($file_info->title); ?></span><br>
                        <span class="pull-left title">File Name: <?php _e($file_info->filename); ?></span>
