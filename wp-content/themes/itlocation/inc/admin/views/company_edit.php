...
<script type='text/javascript' src='http://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&sensor=true&ver=3.6.2'></script>
...
$flag=true;
 ...
 $flag=false;
 $errors[]='Please select atleast one services !!';
 }
 if (empty($_POST['industries'])) {
 $flag=false;
 $errors[]='Please select atleast one industries !!.';
 }
 ...
 if($flag==true){
	...
	if( $_POST['latitude'] != '' && $_POST['longitude'] != '' ){
		...
		$ins=$address_model->new_insert($address_info );
 ...
 if ($_POST['phoneprim']) {
		   ...
		   wp_update_user(array('ID' => $cur_author->ID, 'phoneprim' => $_POST['phoneprim']));
		         }
		        }
                ...
                <div class="span8">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="font-size-14 margin-only-left-10">Show
                            <input type="checkbox" name="user_email_show_fg" value="1" <?php echo ( get_user_meta($cur_author->ID, 'user_email_show_fg', true) == '1') ? 'checked="checked"' : '' ?> class="hidden-show"></span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <span class="font-size-14 margin-only-left-10">Show
                            <input type="checkbox" name="user_phone_show_fg" value="1" <?php echo (get_user_meta($cur_author->ID, 'user_phone_show_fg', true)) ? '' : 'checked="checked"' ?> class="hidden-show"></span>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery('#jquery-live-validation-edit-profile').liveValidation({
            ...
            required: ['user_email', 'companyname', 'username', 'address1','first_name','last_name','comp_city','comp_zip_code','comp_description'],
